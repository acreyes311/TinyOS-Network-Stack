...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f15c66d7840, const void *arg_0x7f15c66d7b40);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f15c664e5e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f15c63f03a0), 
int (*key_eq_fn)(void *arg_0x7f15c63f0b70, void *arg_0x7f15c63f0e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f15c61dcc00, int arg_0x7f15c61dce80);
static double RandomUniform(void );
...
static bool /*NodeC.DroppedNeighborsC*/ListC__1__List__isEmpty(void );
#line 20
static /*NodeC.DroppedNeighborsC*/ListC__1__List__t /*NodeC.DroppedNeighborsC*/ListC__1__List__popfront(void );
#line 18
...
static bool Node__DroppedNeighbors__isEmpty(void );
#line 20
static Node__DroppedNeighbors__t Node__DroppedNeighbors__popfront(void );
#line 18
...
static inline uint16_t Node__minDist(uint16_t Cost[], bool isValid[]);
...
#line 54
static /*NodeC.DroppedNeighborsC*/ListC__1__t /*NodeC.DroppedNeighborsC*/ListC__1__List__popfront(void );
#line 80
static inline bool /*NodeC.DroppedNeighborsC*/ListC__1__List__isEmpty(void );
#line 16
...
static void /*NodeC.NeighborsC*/ListC__2__List__pushback(/*NodeC.NeighborsC*/ListC__2__t input);
#line 54
...
static /*NodeC.NeighborsC*/ListC__2__t /*NodeC.NeighborsC*/ListC__2__List__remove(uint16_t pos);
#line 16
...
static void /*NodeC.tablerouteC*/HashmapC__0__Hashmap__insert(uint32_t k, /*NodeC.tablerouteC*/HashmapC__0__t input);
#line 130
...
inline static Node__DroppedNeighbors__t Node__DroppedNeighbors__popfront(void ){
#line 20
  nx_struct Neighbor __nesc_result;
#line 20

#line 20
  __nesc_result = /*NodeC.DroppedNeighborsC*/ListC__1__List__popfront();
#line 20
...
#line 80
{
  if (/*NodeC.DroppedNeighborsC*/ListC__1__size[sim_node()] == 0) {
    return TRUE;
    }
  else {
#line 84
...
# 23 "dataStructures/interfaces/List.nc"
inline static bool Node__DroppedNeighbors__isEmpty(void ){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  __nesc_result = /*NodeC.DroppedNeighborsC*/ListC__1__List__isEmpty();
#line 23
      ...
      if (AM_BROADCAST_ADDR == __nesc_ntoh_uint16(myMsg->dest.nxdata)) {
          ...
          switch (__nesc_ntoh_uint8(myMsg->protocol.nxdata)) {
              ...
              if (!flag) {
                  ...
                  if (Node__DroppedNeighbors__isEmpty()) {

                      Node__NewNeighbor[sim_node()] = Node__DroppedNeighbors__popfront();
              ...
              if (Node__RouteTable__isEmpty()) {
                  ...
                  __nesc_hton_uint16(temp.seq.nxdata, __nesc_ntoh_uint16(myMsg->seq.nxdata));
              ...
              if (__nesc_ntoh_uint16(myMsg->src.nxdata) != TOS_NODE_ID) {
                  ...
                  if (!Node__RouteTable__isEmpty()) {
                      ...
                      while (!Node__RouteTable__isEmpty()) {
                          ...
                          if (__nesc_ntoh_uint16(LSP.node.nxdata) == __nesc_ntoh_uint16(temp.node.nxdata) && __nesc_ntoh_uint16(LSP.cost.nxdata) < __nesc_ntoh_uint16(temp.cost.nxdata) && __nesc_ntoh_uint16(LSP.seq.nxdata) >= __nesc_ntoh_uint16(temp.seq.nxdata)) {
...
#line 387
      ...
      if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID) 
        {
          sim_log_debug(110U, FLOODING_CHANNEL, "Packet #%d arrived from %d with payload: %s\n", __nesc_ntoh_uint16(myMsg->seq.nxdata), __nesc_ntoh_uint16(myMsg->src.nxdata), myMsg->payload);
          ...
          if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
              ...
              nextHop = 0;
              sim_log_debug(111U, FLOODING_CHANNEL, "Ping replying to %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
              ...
              Node__insertPack(Node__sendPackage[sim_node()]);
              sim_log_debug(112U, GENERAL_CHANNEL, "BEFORE dest.nextHOP\n");
          ...
          if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PINGREPLY) {
              sim_log_debug(113U, FLOODING_CHANNEL, "PING REPLY RECEIVED FROM %d\n ", __nesc_ntoh_uint16(myMsg->src.nxdata));
            }
        }
      else 
...
# 78 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f15c5ecde50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f15c5ecde50) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f15c5ecde50, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f15c5ecca60, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f15c5ecca60, msg, payload, len);
#line 78
...
# 110 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f15c5ee8c80, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f15c5ee8c80, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f15c578cb60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f15c578cb60, addr, msg, len);
#line 80
...
#line 75
# 170 "/home/andrew/Desktop/tiny/tinyos-main/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC__AMPacket__setType(message_t *amsg, am_id_t t)
#line 170
{
...
# 169 "/home/andrew/Desktop/tiny/tinyos-main/tos/system/AMQueueImplP.nc"
static inline void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__errorTask__runTask(void )
#line 169
{
...
# 100 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f15c578e940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f15c578e940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f15c578e940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 517
  ...
  if (size == 0) {
      sim_log_debug(116U, NEIGHBOR_CHANNEL, "-There is no Neighbor to node: %d\n", TOS_NODE_ID);
    }
  else 
    {
      for (i = 0; i < size; i++) {
          nextneightbor = Node__Neighbors__get(i);
          sim_log_debug(117U, NEIGHBOR_CHANNEL, "<--- Has Neighbor: %d\n", __nesc_ntoh_uint16(nextneightbor.nodeID.nxdata));
        }
    }
}
...
#line 491
  ...
  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, destination, MAX_TTL, 0, Node__seqNumber[sim_node()] + 1, payload, PACKET_MAX_PAYLOAD_SIZE);
...
# 75 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f15c60b1320){
#line 75
  switch (arg_0x7f15c60b1320) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f15c60b1320);
#line 75
      break;
#line 75
    }
...
#line 665
  ...
  for (path = 0; path < 10 - 1; path++) {

      V = Node__minDist(Cost, isValid);
      ...
      for (E = 0; E < 10; E++) {
          ...
          if (!isValid[E] && G[V][E] != 9999 && Cost[V] + G[V][E] < Cost[E]) {
              base[E] = V;
              Cost[E] = Cost[V] + G[V][E];
            }
        }
  ...
  for (i = 0; i < 10; i++) {
      ...
      while (base[num] != -1 && base[num] != nextnode && num < 10) {
          num = base[num];
        }
      if (base[num] != nextnode) {
          Node__tableroute__insert(i + 1, 0);
        }
      else 
        {
          Node__tableroute__insert(i + 1, num + 1);
        }
    }
      ...
      for (i = 1; i <= 10; i++) 
        {
          ...
          __nesc_hton_uint16(nextnode2.cost.nxdata, G[TOS_NODE_ID][i]);
...
#line 132
  ...
  if (!Node__Neighbors__isEmpty()) {
      ...
      for (i = 0; i < size; i++) {
          line = Node__Neighbors__get(i);
          (__nesc_temp42 = line.life.nxdata, __nesc_hton_uint16(__nesc_temp42, (__nesc_temp43 = __nesc_ntoh_uint16(__nesc_temp42)) + 1), __nesc_temp43);
          Node__Neighbors__remove(i);
          Node__Neighbors__pushback(line);
        }
      for (i = 0; i < size; i++) {
          temp = Node__Neighbors__get(i);
          ...
          if (__nesc_ntoh_uint16(temp.life.nxdata) > 5) {
  ...
  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, AM_BROADCAST_ADDR, 2, PROTOCOL_PING, 1, (uint8_t *)msg, (uint8_t )sizeof msg);
  Node__insertPack(Node__sendPackage[sim_node()]);
  Node__Sender__send(Node__sendPackage[sim_node()], AM_BROADCAST_ADDR);
}
...
# 83 "/home/andrew/Desktop/tiny/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f15c58ce950){
#line 83
  switch (arg_0x7f15c58ce950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f15c58ce950);
#line 83
      break;
#line 83
    }
...
#line 54
{
  /*NodeC.DroppedNeighborsC*/ListC__1__t returnVal;
  uint16_t i;

  returnVal = /*NodeC.DroppedNeighborsC*/ListC__1__container[sim_node()][0];
  if (/*NodeC.DroppedNeighborsC*/ListC__1__size[sim_node()] > 0) {

      for (i = 0; i < /*NodeC.DroppedNeighborsC*/ListC__1__size[sim_node()] - 1; i++) {
          /*NodeC.DroppedNeighborsC*/ListC__1__container[sim_node()][i] = /*NodeC.DroppedNeighborsC*/ListC__1__container[sim_node()][i + 1];
        }
      /*NodeC.DroppedNeighborsC*/ListC__1__size[sim_node()]--;
    }
...
#line 42
  ...
  if (k == /*NodeC.tablerouteC*/HashmapC__0__EMPTY_KEY[sim_node()]) {
      sim_log_debug(188U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NodeC.tablerouteC*/HashmapC__0__EMPTY_KEY[sim_node()]);
      return;
    }
