...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f2dfba9d840, const void *arg_0x7f2dfba9db40);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f2dfba145e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f2dfb7b63a0), 
int (*key_eq_fn)(void *arg_0x7f2dfb7b6b70, void *arg_0x7f2dfb7b6e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f2dfb5a2c00, int arg_0x7f2dfb5a2e80);
static double RandomUniform(void );
...
# 18 "dataStructures/modules/ListC.nc"
  ...
  if (len == sizeof(pack )) 
    {
      ...
      if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) == 0) {
          ...
          sim_log_debug(112U, FLOODING_CHANNEL, "TTL = 0, PACKET #%d from %d to %d being dropped\n", __nesc_ntoh_uint16(myMsg->seq.nxdata), __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata));
        }
      if (Node__isKnown(myMsg)) {
          sim_log_debug(113U, FLOODING_CHANNEL, "Already seen PACKET #%d from %d to %d being dropped\n", __nesc_ntoh_uint16(myMsg->seq.nxdata), __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata));
        }
      else {
        if (AM_BROADCAST_ADDR == __nesc_ntoh_uint16(myMsg->dest.nxdata)) {
            sim_log_debug(114U, NEIGHBOR_CHANNEL, "Received a Ping Reply from %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
            ...
            switch (__nesc_ntoh_uint8(myMsg->protocol.nxdata)) {
                ...
                case PROTOCOL_PINGREPLY: 
                  ...
                  sim_log_debug(115U, NEIGHBOR_CHANNEL, "Node %d is neighbor of %d\n", __nesc_ntoh_uint16(Node__TempNeighbor[sim_node()].nodeID.nxdata), __nesc_ntoh_uint16(myMsg->src.nxdata));
                ...
                for (i = 0; i < size; i++) {
                    ...
                    if (__nesc_ntoh_uint16(Node__TempNeighbor[sim_node()].nodeID.nxdata) == __nesc_ntoh_uint16(myMsg->src.nxdata)) {
                        ...
                        __nesc_hton_uint16(Node__TempNeighbor[sim_node()].hops.nxdata, 0);
                        flag = TRUE;
                        break;
                      }
                    sim_log_debug(116U, NEIGHBOR_CHANNEL, "Received a Ping Reply from %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
                  }
                ...
                if (!flag) {
                    ...
                    sim_log_debug(117U, NEIGHBOR_CHANNEL, "New Neighbor %d found and adding to our list\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
                    ...
                    if (Node__DroppedNeighbors__isEmpty()) {
                        ...
                        __nesc_hton_uint16(Node__NewNeighbor[sim_node()].hops.nxdata, 0);

                        Node__Neighbors__pushback(Node__NewNeighbor[sim_node()]);
                        sim_log_debug(118U, GENERAL_CHANNEL, "pushback New Neighbor!\n");
                      }
                    else {
                        Node__NewNeighbor[sim_node()] = Node__DroppedNeighbors__popfront();
                        __nesc_hton_uint16(Node__NewNeighbor[sim_node()].nodeID.nxdata, __nesc_ntoh_uint16(myMsg->src.nxdata));
          ...
          if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID) 
            {
              ...
              if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
                  sim_log_debug(120U, FLOODING_CHANNEL, "Ping replying to %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
              ...
              if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PINGREPLY) {
                  sim_log_debug(121U, FLOODING_CHANNEL, "PING REPLY RECEIVED FROM %d\n ", __nesc_ntoh_uint16(myMsg->src.nxdata));
                }
            }
          else 
...

            {
              ...
              sim_log_debug(122U, FLOODING_CHANNEL, "Packet from %d, intended for %d is being Rebroadcasted.\n", __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata));
              Node__insertPack(Node__sendPackage[sim_node()]);
              Node__Sender__send(Node__sendPackage[sim_node()], AM_BROADCAST_ADDR);
            }
          }
...
# 78 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f2dfb293e50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f2dfb293e50) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f2dfb293e50, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f2dfb292a60, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f2dfb292a60, msg, payload, len);
#line 78
...
# 110 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f2dfb2aec80, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f2dfb2aec80, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f2dfabc6b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f2dfabc6b60, addr, msg, len);
#line 80
...
# 100 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f2dfabc7940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f2dfabc7940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f2dfabc7940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 308
{
  sim_log_debug(124U, GENERAL_CHANNEL, "PING EVENT____________________________________ \n");


  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, destination, MAX_TTL, 0, Node__seqNumber[sim_node()], payload, PACKET_MAX_PAYLOAD_SIZE);
  Node__Sender__send(Node__sendPackage[sim_node()], AM_BROADCAST_ADDR);
  Node__seqNumber[sim_node()] = Node__seqNumber[sim_node()] + 1;
}
...
# 75 "/home/andrew/Desktop/tiny/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f2dfb477320){
#line 75
  switch (arg_0x7f2dfb477320) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f2dfb477320);
#line 75
      break;
#line 75
    }
...
#line 102
  ...
  if (!Node__Neighbors__isEmpty()) {
      sim_log_debug(109U, NEIGHBOR_CHANNEL, "NeighborList, node %d looking for neighbor\n", TOS_NODE_ID);


      for (i = 0; i < size; i++) {
          line = Node__Neighbors__get(i);
          (__nesc_temp42 = line.hops.nxdata, __nesc_hton_uint16(__nesc_temp42, (__nesc_temp43 = __nesc_ntoh_uint16(__nesc_temp42)) + 1), __nesc_temp43);
      ...
      for (i = 0; i < size; i++) {
          ...
          if (__nesc_ntoh_uint16(temp.hops.nxdata) > 5) {

              Node__Neighbors__remove(i);
              sim_log_debug(110U, NEIGHBOR_CHANNEL, "Node %d has EXPIRED and DROPPED from Node %d\n", __nesc_ntoh_uint16(line.nodeID.nxdata), TOS_NODE_ID);
...
# 83 "/home/andrew/Desktop/tiny/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f2dfad07950){
#line 83
  switch (arg_0x7f2dfad07950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f2dfad07950);
#line 83
      break;
#line 83
    }
