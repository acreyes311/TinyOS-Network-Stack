         ...
         //}
          ...
          // switch(myMsg->protocol) {
               ...
               if(myMsg->protocol == PROTOCOL_PING)
               {
                  ...
                  makePack(&sendPackage, TOS_NODE_ID, myMsg->TTL, MAX_TTL, PROTOCOL_PINGREPLY, seqNumber, (uint8_t *) myMsg->payload, sizeof(myMsg->payload)) ;//PACKET_MAX_PAYLOAD_SIZE);
                  seqNumber++;
              ...
              // case PROTOCOL_PINGREPLY:
               if(myMsg->protocol == PROTOCOL_PINGREPLY) 
               {
                  ...
                  // CAN TRY A WHILE LOOP ??
                     ...
                     //call Packets.pushback(myMsg ->src);
                 // break;
               }
